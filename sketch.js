...
function preload() {
  ...
  // テーブルを非同期で読み込む
  this.hiraganaTable = loadTable(hiraganaCsv, "header", onTableLoadSuccess, onTableLoadError);
  this.questionsTable = loadTable(questionsCsv, "header", onTableLoadSuccess, onTableLoadError);
}
